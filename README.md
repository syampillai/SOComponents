...
## Dependencies
https://vaadin.com/directory/component/textfield-formatter Ver 4.2.0 or later (for field formatting features).  
Use versions < 1.3.0 if you don't want this dependency.

https://vaadin.com/directory/component/multiselect-combo-box Ver 3.0.1 or later (for TokensField).  
